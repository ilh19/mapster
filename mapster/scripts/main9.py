...
countries = ['Ukraine', 'Namibia', 'Nigeria', 'Bahrain', 'Puerto+Rico']
class CronMailer(webapp.RequestHandler):
    def get(self):
        ...
        mail.send_mail(sender="irms19@gmail.com",
            ...
            body="Scores and tables have been updated 9 have been computed!")
        logging.info("Get news: Finished!")

application = webapp.WSGIApplication([('/cron9', CronMailer)],debug=True)
def main():
