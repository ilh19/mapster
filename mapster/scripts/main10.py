...
countries = ['Kenya', 'Guinea', 'Belize', 'Algeria', 'Haiti']
class CronMailer(webapp.RequestHandler):
    def get(self):
        ...
        mail.send_mail(sender="irms19@gmail.com",
            ...
            body="Scores and tables have been updated 10 have been computed!")
        logging.info("Get news: Finished!")

application = webapp.WSGIApplication([('/cron10', CronMailer)],debug=True)
def main():
