...
countries = ['Japan', 'North+Korea', 'South+Korea', 'Iran', 'Iraq', 'Afghanistan']
class CronMailer(webapp.RequestHandler):
    def get(self):
        ...
        mail.send_mail(sender="irms19@gmail.com",
            ...
            body="Scores and tables have been updated 8 have been computed!")
        logging.info("Get news: Finished!")

application = webapp.WSGIApplication([('/cron8', CronMailer)],debug=True)
def main():
