...
def get_news(query):
    ...
    # gets news
    try:
        #http://api.nytimes.com/svc/search/v1/article?format=json&query=Houston&begin_date=20111028&end_date=20111030&rank=newest&api-key=
##        url = "http://api.nytimes.com/svc/search/v1/article?format=json&query="+query+ \
##              "&facets=des_facet%2Cper_facet%2Cgeo_facet%2Cclassifiers_facet%2Corg_facet&begin_date="+\
##              startDate+"&end_date="+endDate+"&rank=newest&api-key=" + api_key
        url = "http://api.nytimes.com/svc/search/v1/article?format=json&query="+query+ \
              "&begin_date="+startDate+"&end_date="+endDate+"&rank=newest&api-key=" + api_key
##        url = "http://api.nytimes.com/svc/search/v1/article?format=json&query=Mexico&begin_date=20111104&end_date=20111106&rank=newest&api-key="+api_key
        print url
